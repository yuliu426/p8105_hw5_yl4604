...
comparing to sample average of all samples, the sample average of μ^ across tests for which the null is rejected are slightly bigger than true value of μ. This is because
